...
import { setPage, getActivity } from '../../../redux/action';
...
export default function Cards() {
    ...
    const [selectedActivity, setActivity] = useState("ACTIVITY"); //! estado local para filtrar los paises con actividad
    ...
    const filterActivity = selectedActivity === "ACTIVITY"
        ? actividad
        : actividad.filter((na)=> na.name === selectedActivity )
    ...
    return (
        <div className={style.cardsContainer}>
            <div className={style.filtrados}>
                ...
                <select className={style.filters} value={selectedContinent} onChange={(e) => handleFilterChange(e.target.value)}>
